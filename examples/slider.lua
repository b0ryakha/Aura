...
local slider1 = aura.Slider(Vector2:new(500, 10), left)
local slider2 = aura.Slider(Vector2:new(500, 10), left)
local slider3 = aura.Slider(Vector2:new(500, 40), left)
local disabled_slider = aura.Slider(Vector2:new(500, 10), left)

local slider4 = aura.Slider(Vector2:new(10, 300), right)
local slider5 = aura.Slider(Vector2:new(40, 300), right)
local slider6 = aura.Slider(Vector2:new(10, 300), right)
